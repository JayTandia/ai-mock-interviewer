...
function Header() {
  ...
  return (
    ...
    <ul className='hidden md:flex gap-6'>
        <li className={`hover:text-primary hover:font-bold cursor-pointer transition-all ${path=='/dashboard'&&'text-primary font-bold'}`}>Dashboard</li>
        ...
        <li className={`hover:text-primary hover:font-bold cursor-pointer transition-all ${path=='/dashboard/upgrade'&&'text-primary font-bold'}`}>Upgrade</li>
